...
import {
  ...
  Edit3, Trash2, PlusCircle, Download, FileText,
...
=======
  ...
  return (
    <div className="dashboard-vendor">
      ...
      <AddListingWizard isOpen={showAddListing} onClose={() => setShowAddListing(false)} vendor={vendor} onListingAdded={(newListing) => { setVendorListings(prev => [...prev, newListing]); setShowAddListing(false) }} />
